...
import 'package:mobile_final/Games/games_model/02_mild/02_squat/pose_detector_views_squat.dart';
...
class PoseDetectorView_lunges extends StatefulWidget {
  final bool useClassifier;
  final bool isActivity;
  final int scoreSum;
  final int getplaytime;

  const PoseDetectorView_lunges({
...
class _PoseDetectorViewState extends State<PoseDetectorView_lunges> {
    ...
    while (_running) {
      ...
      if (playTime == 30) {
        ...
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => PoseDetectorView_squat(
                      scoreSum: _sumScore,
