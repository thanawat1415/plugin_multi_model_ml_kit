...
import 'games_model/01_warm_up/01_arm_stretch_and_full/pose_detector_views_arm_strech_and_full.dart';
            ...
            GestureDetector(
              onTap: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                      builder: (context) => const PoseDetectorView_arm_strech_and_full(
                          // useClassifier: true,
                          // isActivity: true,
                          )),
                );
              ...
              child: Container(
                ...
                child: Center(
                  child: Text(
                    "เริ่มเกม VisionDetectorViews lunges",
                    style: TextStyle(
                      fontSize: 16,
                      fontWeight: FontWeight.bold,
                      color: Colors.white,
