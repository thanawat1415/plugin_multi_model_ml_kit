...
import com.google_ml_kit_elbow_plank.vision.PoseDataStorage;
...
public class PoseClassifierProcessor {
    ...
    private static final String POSE_SAMPLES_FILE = "pose/02_elbow_plank.csv";
    private static final String POSE_ACTIVITY = "pose/02_elbow_plank.csv";
    ...
    private static final String PUSHUPS_CLASS = "plank";
    private static final String SQUATS_CLASS = "ready";
